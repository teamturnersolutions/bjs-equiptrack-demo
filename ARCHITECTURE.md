...
Integrate Univer as a power-user administrative workspace.

Purpose:

Provide an Excel-like interface for bulk data management.
...
The spreadsheet must never communicate directly with the database.

All edits must pass through application services.
